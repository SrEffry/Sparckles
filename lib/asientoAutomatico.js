...
export function movimientosDeNomina(n, mapa) {
  ...
  a.debito(mapa.gastoAportesPatronales, n.totalAportesPatronales, {
    concepto: "Gasto de aportes patronales",
    tercero,
  });
  a.debito(mapa.gastoPrestaciones, n.totalPrestaciones, {
    concepto: "Gasto de prestaciones sociales",
    tercero,
  });
