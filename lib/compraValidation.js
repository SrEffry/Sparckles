...
export function normalizarCompra(body) {
  ...
  const items = itemsValidos.map((i) => {
    ...
    return {
      ...
      // Lo declara el usuario y el servidor solo lo normaliza: si es activo fijo o movible
      // depende del uso que la empresa le dé al bien, y eso no se deduce de la descripción.
      esActivoFijo: !!i.esActivoFijo,
    };
  });
