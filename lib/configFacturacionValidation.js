...
export function normalizarConfig(body) {
  ...
  const data = {
    ...
    regimen,
    responsableIva,
    // Art. 114-1 E.T. Decide si la nómina liquida salud patronal, SENA e ICBF. Es criterio del
    // contador: el software no puede deducir si la empresa califica.
    exoneradoParafiscales: body.exoneradoParafiscales === true,
    direccion,
    ciudad,
    telefono,
    email,
