...
export const SUGERENCIAS = {
  comercial: {
    ...
    // La 24080501 se llama literalmente "IVA Generado Ventas 19%" y la 24081001 "IVA Descontable
    // Compras 19%", pero ahí se acredita y se debita TAMBIÉN el IVA del 5% y el de cualquier otra
    // tarifa: el nombre de la cuenta acababa contradiciendo su saldo, y la conciliación contra el
    // Formulario 300 se hacía a ciegas. Las cuentas agregadas `240805`/`240810` existen, son
    // imputables y no prejuzgan la tarifa. Quien quiera un auxiliar por tarifa los abre en su
    // plan y los mapea aquí.
    ivaGenerado: "240805",
