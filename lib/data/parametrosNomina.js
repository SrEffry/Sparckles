...
export const VALORES_ANUALES = {
  2026: {
    ...
    norma: "Decretos 1469 y 1470 del 29 de diciembre de 2025",
    confirmado: true,
    // El Consejo de Estado suspendió provisionalmente el Decreto 1469 en febrero de 2026 y
    // después revocó la suspensión: el decreto está vigente y este es el valor aplicable, pero
    // el proceso de fondo sigue abierto. Por eso estos números tienen que poder cambiarse sin
    // tocar código.
    nota: "El Decreto 1469 tuvo una suspensión provisional que fue revocada; el proceso de fondo continúa.",
  },
  2025: {
    smlmv: 1423500,
 ...
 */
export function aplicaExoneracion({ exoneradoEmpleador, devengadoMes, smlmv }) {
  if (!exoneradoEmpleador) return false;
  return Number(devengadoMes) < 10 * Number(smlmv);
}
