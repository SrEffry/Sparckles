...
export const PLAZOS_EXOGENA = {
  ...
  2025: {
    ...
    //
    // ⚠️ OJO: la Res. 000012/2026 AMPLIÓ los plazos de los dígitos 1, 2 y 3 (que originalmente
    // vencían el 28-abr, 29-abr y 4-may). Cualquier tabla anterior a esa resolución —incluida la
    // del libro de Excel que aportó el cliente— trae las fechas viejas. Los dígitos 4 a 0 se
    // toman de la tabla original y **están por confirmar** contra el texto de la modificación.
    grandesContribuyentes: [
      ...
      { digito: "4", fecha: iso(2026, 5, 5), fuente: "tabla original — por confirmar" },
      { digito: "5", fecha: iso(2026, 5, 6), fuente: "tabla original — por confirmar" },
      { digito: "6", fecha: iso(2026, 5, 7), fuente: "tabla original — por confirmar" },
      { digito: "7", fecha: iso(2026, 5, 8), fuente: "tabla original — por confirmar" },
      { digito: "8", fecha: iso(2026, 5, 11), fuente: "tabla original — por confirmar" },
      { digito: "9", fecha: iso(2026, 5, 12), fuente: "tabla original — por confirmar" },
      { digito: "0", fecha: iso(2026, 5, 13), fuente: "tabla original — por confirmar" },
    ],
  },
...
export function dosUltimosDigitos(nit) {
  const solo = (nit || "").toString().replace(/\D/g, "");
