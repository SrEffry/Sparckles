...
function dibujar(doc, c, opciones, W, H) {
  ...
  doc.text(recortar(doc, emisor.razonSocial || c.emisorRazonSocial || "—", anchoEmisor), xE, y + 8);
  ...
  const extras = [
    c.cuentaTesoreriaNombre
      ...
      : null,
    // Dirección del beneficiario: la pide la información exógena. (El certificado de
    // retención exige la del agente retenedor, que va en el encabezado.)
