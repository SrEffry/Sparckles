...
/**
 * Documento soporte: SIEMPRE vinculante, sin mirar la política.
 *
 * La política existe para no contar dos veces la misma retención cuando hay dos documentos —la
 * causación y el pago—. El documento soporte no tiene contraparte en tesorería: un comprobante
 * de egreso solo se aplica a COMPRAS (`comprobanteValidation`), nunca a un soporte. Si aquí se
 * respetara `vinculante: causadas`, con la política de "registrar al pagar" la retención del
 * soporte quedaría en `false` y NADIE escribiría la fila vinculante: desaparecería del
 * certificado y del listado de pendientes, en silencio.
 */
